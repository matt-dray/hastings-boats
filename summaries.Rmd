...
subtitle: "Exploring the data for presentation in a Shiny app"
author: "Matt Dray"
date: "March 2018"
output:
  html_document:
...
Prepare the environment by loading packages and reading in the data.
...
```{r}
boats_clean %>% janitor::tabyl(still_on_stade)
```
